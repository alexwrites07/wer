...
function Application() {
   ...
   <span className="qaz">
    ...
    <h6 className="text-1xl leading-tight text-[#8AA6AA] sd" color="blue">"Unleashing the Power of BFS Technology: Aseptic Filling, Sterile Containers, and Unbreakable Packaging in a Single Step!"</h6></span> <br></br>
    <button class="bg-[#8AA6AA] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
  Explore
</button>
  </div><br></br><br></br>
  <div> <img
